...
import { modelCapabilityConfigFor, normalizeImageValue, workflowImageCapabilityConfig, type ImageCapabilityConfig, type ImageResolutionTier, type WorkflowVideoFieldLike } from "@/lib/model-capabilities";
...
export function ImageSettingsPanel({ config, workflowFields = [], onConfigChange, theme, showTitle = true, showQuality = true, showTransparent = true, showSize = true, showCount = true, className = "w-[304px] space-y-3 rounded-2xl px-1 py-0.5", maxCount = 15, quickCount = 3, bypassPriceGuard = false }: ImageSettingsPanelProps) {
